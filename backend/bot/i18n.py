...
_TEXT["en"].update({
    ...
    "transcription_retrying": "⚠️ A temporary backend problem occurred. Your job is saved and will retry automatically in about {retry_minutes} min.",
...
_TEXT["ru"].update({
    ...
    "transcription_retrying": "⚠️ Произошла временная ошибка сервера. Задание сохранено и будет повторено примерно через {retry_minutes} мин.",
...
_TEXT["az"].update({
    ...
    "transcription_retrying": "⚠️ Müvəqqəti server xətası baş verdi. Tapşırıq yadda saxlanıldı və təxminən {retry_minutes} dəqiqəyə avtomatik təkrar ediləcək.",
